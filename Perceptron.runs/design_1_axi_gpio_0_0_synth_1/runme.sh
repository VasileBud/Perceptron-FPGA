...
HD_PWD='D:/Facultate/AN3/Sem1/SSC/Proiect/Perceptron-FPGA_delta_perceptron/Perceptron-FPGA_delta_perceptron/Perceptron-FPGA/Perceptron.runs/design_1_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
